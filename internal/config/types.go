...
type cliConfig struct {
	...
	ConfigFile *string `toml:"-" arg:"--config-file,env:QUERY_AUMETA_CONFIG_FILE" help:"Fully-qualified path to required TOML-formatted configuration file. See contrib/qm/config.example.toml for a starter template."`
}
...
type fileConfig struct {
	...
	// FileRuntimeLog *string `toml:"file_runtime_log" arg:"--runtime-log,env:QUERY_AUMETA_FILE_RUNTIME_LOG" help:"The fully-qualified path to a runtime or operational messages log file. Error messages are recorded separately."`
	// FileErrorLog   *string `toml:"file_error_log" arg:"--error-log,env:QUERY_AUMETA_FILE_ERROR_LOG" help:"The fully-qualified path to an error log file. Runtime or operational messages are recorded separately."`
	// FileOutput     *string `toml:"file_output" arg:"--output-file,env:QUERY_AUMETA_FILE_OUTPUT" help:"The fully-qualified (and writable) path to the output file to be generated by this application."`
}
