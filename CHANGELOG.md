...
- (GH-633) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.22.9 to go-ci-oldstable-build-v0.22.10 in /dependabot/docker/builds
- (GH-629) Go Dependency: Bump golang.org/x/crypto from 0.37.0 to 0.38.0
- (GH-630) Go Dependency: Bump golang.org/x/sys from 0.32.0 to 0.33.0
- (GH-628) Go Dependency: Bump golang.org/x/text from 0.24.0 to 0.25.0
- (GH-631) Go Runtime: Bump golang from 1.23.8 to 1.23.9 in /dependabot/docker/go
...
- (GH-418) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.4 to go-ci-oldstable-build-v0.20.5 in /dependabot/docker/builds
- (GH-422) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.5 to go-ci-oldstable-build-v0.20.6 in /dependabot/docker/builds
- (GH-434) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.6 to go-ci-oldstable-build-v0.20.7 in /dependabot/docker/builds
- (GH-421) Go Dependency: Bump github.com/rs/zerolog from 1.32.0 to 1.33.0
- (GH-428) Go Dependency: Bump golang.org/x/crypto from 0.23.0 to 0.24.0
- (GH-427) Go Dependency: Bump golang.org/x/sys from 0.20.0 to 0.21.0
- (GH-426) Go Dependency: Bump golang.org/x/text from 0.15.0 to 0.16.0
- (GH-425) Go Runtime: Bump golang from 1.21.10 to 1.21.11 in /dependabot/docker/go

### Fixed

- (GH-424) Remove inactive maligned linter
...
- (GH-398) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.1 to go-ci-oldstable-build-v0.20.2 in /dependabot/docker/builds
- (GH-409) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.2 to go-ci-oldstable-build-v0.20.3 in /dependabot/docker/builds
- (GH-411) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.20.3 to go-ci-oldstable-build-v0.20.4 in /dependabot/docker/builds
- (GH-413) Go Dependency: Bump github.com/alexflint/go-arg from 1.4.3 to 1.5.0
- (GH-394) Go Dependency: Bump github.com/pelletier/go-toml/v2 from 2.2.0 to 2.2.1
- (GH-397) Go Dependency: Bump github.com/pelletier/go-toml/v2 from 2.2.1 to 2.2.2
- (GH-405) Go Dependency: Bump golang.org/x/crypto from 0.22.0 to 0.23.0
- (GH-402) Go Dependency: Bump golang.org/x/sys from 0.19.0 to 0.20.0
- (GH-403) Go Dependency: Bump golang.org/x/text from 0.14.0 to 0.15.0
- (GH-406) Go Runtime: Bump golang from 1.21.9 to 1.21.10 in /dependabot/docker/go
...
- (GH-376) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.15.4 to go-ci-oldstable-build-v0.16.0 in /dependabot/docker/builds
- (GH-378) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.16.0 to go-ci-oldstable-build-v0.16.1 in /dependabot/docker/builds
- (GH-379) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.16.1 to go-ci-oldstable-build-v0.19.0 in /dependabot/docker/builds
- (GH-381) Build Image: Bump atc0005/go-ci from go-ci-oldstable-build-v0.19.0 to go-ci-oldstable-build-v0.20.0 in /dependabot/docker/builds
...
- (GH-373) Go Dependency: Bump github.com/pelletier/go-toml/v2 from 2.1.1 to 2.2.0
- (GH-388) Go Dependency: Bump golang.org/x/crypto from 0.21.0 to 0.22.0
- (GH-387) Go Dependency: Bump golang.org/x/sys from 0.18.0 to 0.19.0
- (GH-383) Go Runtime: Bump golang from 1.21.8 to 1.21.9 in /dependabot/docker/go
...
- (GH-342) canary: bump golang from 1.20.13 to 1.20.14 in /dependabot/docker/go
- (GH-324) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.3 to go-ci-oldstable-build-v0.14.4 in /dependabot/docker/builds
- (GH-328) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.4 to go-ci-oldstable-build-v0.14.5 in /dependabot/docker/builds
- (GH-330) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.5 to go-ci-oldstable-build-v0.14.6 in /dependabot/docker/builds
- (GH-344) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.6 to go-ci-oldstable-build-v0.14.9 in /dependabot/docker/builds
...
- (GH-331) go.mod: bump github.com/rs/zerolog from 1.31.0 to 1.32.0
- (GH-337) go.mod: bump golang.org/x/crypto from 0.18.0 to 0.19.0
- (GH-338) go.mod: bump golang.org/x/sys from 0.16.0 to 0.17.0
...
- (GH-319) canary: bump golang from 1.20.12 to 1.20.13 in /dependabot/docker/go
- (GH-321) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.2 to go-ci-oldstable-build-v0.14.3 in /dependabot/docker/builds
- (GH-309) ghaw: bump github/codeql-action from 2 to 3
- (GH-307) go.mod: bump github.com/pelletier/go-toml/v2 from 2.1.0 to 2.1.1
- (GH-316) go.mod: bump golang.org/x/crypto from 0.16.0 to 0.18.0
- (GH-314) go.mod: bump golang.org/x/sys from 0.15.0 to 0.16.0
...
- (GH-301) canary: bump golang from 1.20.11 to 1.20.12 in /dependabot/docker/go
- (GH-304) docker: bump atc0005/go-ci from go-ci-oldstable-build-v0.14.1 to go-ci-oldstable-build-v0.14.2 in /dependabot/docker/builds
- (GH-297) go.mod: bump golang.org/x/crypto from 0.15.0 to 0.16.0
- (GH-298) go.mod: bump golang.org/x/sys from 0.14.0 to 0.15.0
...
[Unreleased]: https://github.com/atc0005/query-meta/compare/v0.4.17...HEAD
[v0.4.17]: https://github.com/atc0005/query-meta/releases/tag/v0.4.17
